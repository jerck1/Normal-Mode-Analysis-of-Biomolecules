...
\caption{Modelos escogidos de acuerdo a la escala del movimiento y al tiempo de la simulaci\'{o}n computacional. Figura tomada de  \cite{RamoNormalBiology}.} \label{fig:esc}
\end{figure}
...
m_i\frac{\mathrm{d}\mathbf{r_i}}{\mathrm{d}t}=\nabla_\mathbf{r_i} V_i
\end{equation}
