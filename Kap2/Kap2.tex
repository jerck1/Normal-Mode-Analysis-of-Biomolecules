...
pesar de las diferencias, ellas tienden a formar dos tipos de plegamientos, el de \textit{prote\'{i}nas fibrosas} y el de 
...
hidrof\'{o}bicos tienden a estar en el interior debido al agua.\\

La clasificaci\'{o}n de prote\'{i}nas globulares y fibrosas es limitada y no \'{u}nica, de hecho, en la base de datos SCOPUS2, las 
...
Son las prote\'{i}nas encontradas en la bicapa fosfolip\'{i}da de la membrana celular. En la FIGURA  se muestra la membrana 
...
En la FIGURA se observan macromol\'{e}culas unidas a cada membrana, donde se muestran algunas prote\'{i}nas de membrana. Algunas de 
estas atraviesan la membrana (prote\'{i}nas integrales de membrana) mientras que otras s\'{o}lamnete est\'{a}n hacia el interior o 
