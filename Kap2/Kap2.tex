...
Dos amino\'{a}cidos reaccionan formando un enlace llamado pept\'{i}dico, esto ocurre cuando el carbono del grupo carboxilo en el primer amino\'{a}cido se enlaza covalentemente con el nitr\'{o}geno del grupo amino en el segundo amino\'{a}cido, produciendo una deshidrataci\'{o}n, es decir, liberando agua. En la figura \ref{fig:pepti} se muestran los reactantes y los productos de la reacci\'{o}n.
\begin{figure}[H]
\centering
\definesubmol\a{C^{\alpha}(-[:270]H)(-[:0]C(=[:270]O)(-[:0]|{\color{blue}OH}))(-[:180]NH_{2})(-[:90]R^{1})}
\definesubmol\b{C^{\alpha}(-[:270]H)(-[:0]COOH)(-[:180]N(-[:90]H)(-[:180]|{\color{blue}H}))(-[:90]R^{2})}
\definesubmol\c{C^{\alpha}(-[:90]R^{1})(-[:270]H)(-[:0]C(=[:270]O)(-[:0]N(-[:90]H)(-[:0]C^{\alpha}(-[:90]R^{2})(-[:270]H)(-[:0]COOH))))(-[:180]NH_{2})}
\schemestart
\chemfig[][scale=0.65]{!\a}\+\chemfig[][scale=0.75]{!\b}
\arrow{<=>[][\chemfig[scale=0.4]{H_{2}O}]}[0,0.8]
\chemfig[][scale=0.65]{!\c}
\schemestop
