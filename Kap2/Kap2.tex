...
Actualmente los simportadores de \ce{Na^+}-soluto, son una familia de prote\'{i}nas de membrana, denotada como SSS (en ingl\'{e}s Sodium Solute Symporter). La cual, 
...
En la caracterizaci\'{o}n de vSGLT, se encuentra reportada una  masa de 60676 Da y 543 residuos. Adem\'{a}s este puede transportar como mon\'{o}mero, ver figura \label{fig:complejo} (a) y principalmente transporta galactosa, aunque con un menor rendimiento puede transportar glucosa y fructosa.\\
