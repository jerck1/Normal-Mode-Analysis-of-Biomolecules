...
La forma en que se escribir\'{a}n los elementos de la masa del sistema depende de la transformaci\'{o}n aplicada. Por ejemplo, en una dimensin las componentees de $\mathbf{q}$ se definen como:
\begin{equation}
q_i=
