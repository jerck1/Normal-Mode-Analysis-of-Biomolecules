...
Existen simulaciones MD usando todos los \'{a}tomos (Full atomic MD) o usando los movimientos globales (Coarse-grained models). En general se pueden considerar los campos de fuerza usados en el modelo de Amber \cite{Amber2016}. El modelo de Amber tiene en cuenta las contribuciones debidas a:
 \begin{itemize}
...
\end{eqnarray}
\end{itemize}
Las constantes $k_r,k_\theta,f_{ij},\epsilon_{ij},r_{0ij},$ son constantes emp\'{i}ricas definidas de manera diferente en cada uno de los programas que realizan din\'{a}mica molecular com AMBER \cite{Amber2016}, NAMD, CHARMm, entre otros..\\
