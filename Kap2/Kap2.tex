...
En \eqref{eq:8} $x_i$ son las desviaciones de la posici\'{o}n de equilibrio de la part\'{i}cula $i$ y $x_{i0}$ su posici\'{o}n de equilibrio. Para este caso particular \eqref{eq:7} se convierte en:
\begin{eqnarray}
