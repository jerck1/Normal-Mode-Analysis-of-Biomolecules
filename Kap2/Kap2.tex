...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{Kap2/vSGLT_inward.png}
\includegraphics[scale=0.1]{Kap2/vSGLT_in1.png}
\includegraphics[scale=0.1]{Kap2/vSGLT_in2.png}
\caption{14 segmentos transmembranales de vSGLT mostrando la galactosa ocluida }\label{fig:3dh4_2}
\end{figure}
