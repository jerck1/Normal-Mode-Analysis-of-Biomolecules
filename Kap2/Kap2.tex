...
V=\left\{\begin{array}{cl}
   \frac{1}{2}\sum_{i,j=1}^{N}\gamma_{ij}\left(R_{ij}-R_{ij}^0\right)^2 &\mbox{  si } R_{ij},R_{ij}^0<R_c\\
   0 &\mbox{  Otro caso}
  \end{array}
\right.
...
\mathbf{H}_{ij}=\left(
\begin{array}{ccc}
 \partial_x\partial_x V & \partial_x\partial_x V & \partial_x\partial_x V \\
 \partial_x\partial_x V & \partial_x\partial_x V & \partial_x\partial_x V \\
 \partial_x\partial_x V & \partial_x\partial_x V & \partial_x\partial_x V
\end{array}
\right)
...
O:
\begin{equation}
\frac{\partial^2 V }{\partial x_i\partial x_j}\bigg|_{R_{ij}=R_{ij}^0}=\frac{\gamma_{ij}x_{ij}y_{ij}}{R_{ij}^2}
\end{equation}\label{eq:4}
