...
\subsubsection{Prote\'{i}nas de Membrana}
Son las prote\'{i}nas encontradas en la bicapa fosfolip\'{i}da de la membrana celular. En la figura  \ref{fig:cell} se muestra la membrana 
lip\'{i}dica de una de una bacteria. Las bacterias, a diferencia de los eukariontes, tienen dos membranas, una conocida como pared 
celular y otra simplemente membrana celular.\\

En la figura \ref{fig:cell} se observan macromol\'{e}culas unidas a cada membrana, donde se muestran algunas prote\'{i}nas de membrana. Algunas de 
...
el exterior de la c\'{e}lula, conocidas como prote\'{i}nas de membrana perif\'{e}ricas.\\
\begin{figure}[H]
\centering
