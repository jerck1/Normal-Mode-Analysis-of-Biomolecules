...
<<<<<<< HEAD
Ejemplos de simportadores que transportan el sodio acoplado con otros solutos son el transportador de \ce{Na^{+}/I^{-}} NIS presente en las , 
Actualmente los simportadores de \ce{Na^+}-soluto, son una familia de prote\'{i}nas de membrana, denotada como SSS (en ingl\'{e}s Sodium Solute Symporter).
=======
...
>>>>>>> c897e87a98ecc4e86384bc74950d2f829fa5c3fa
...
La estructura de vSGLT se ha determinado mediante difracci\'{o}n de rayos X. 
En dichos estudios se establece que vSGLT es similar en la estructura primaria y terciaria a otros transportadores de la familia SLC5 como por ejemplo NIS, SGLT1, SGLT2.\\
=======
...
La estructura tridimensional de vSGLT se obtiene por difracci\'{o}n de rayos x con una resoluci\'{o}n de $2.7\AA$, esta es la resoluci\'{o}n dada por los rayos x emitidos de una placa de cobre y corresponde al tama\~{n}o \cite{Huang2007}
>>>>>>> c897e87a98ecc4e86384bc74950d2f829fa5c3fa
