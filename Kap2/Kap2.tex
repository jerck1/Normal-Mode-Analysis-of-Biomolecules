...
\begin{figure}[H]
\centering
\includegraphics[scale=0.07]{Kap2/vSGLT_in1.png}
\put(-40,0){(a)}
\includegraphics[scale=0.07]{Kap2/vSGLT_in2.png}
\put(-40,0){(b)}
\vspace{10mm}
\includegraphics[scale=0.1]{Kap2/vSGLT_inward.png}
\put(-50,70){Out}
\put(-50,-5){In}
\put(-60,0){(c)}
...
\end{figure}
El n\'{u}mero de segmentos transmembranales TM es de 14, distribuidos entre los residuos:\\
