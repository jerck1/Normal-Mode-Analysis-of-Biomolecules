...
Cuando la energ\'{i}a total del sistema fluct\'{u}a poco, es decir, no hay un intercambio de energ\'{i}a apreciable y las m\'{i}nimas fluctuaciones son mucho mayores que la incertidumbre en la energ\'{i}a, entonces el sistema est\'{a} descrito por el ensamble micro can\'{o}nico. Esto se satisface para las peque\~{n}as oscilaciones ya que se asume la energ\'{i} total como fija .\\
