...
\centering
\schemestart
\chemfig{C^{\alpha}(-[:270]H)(-[:0]C(=[:270]O)(-[:0]OH))(-[:180]NH_{2})(-[:90]R^{1})}\+
\chemfig{C^{\alpha}(-[:270]H)(-[:0]C(=[:270]O)(-[:0]OH))(-[:180]NH(-[:90]H)(-[:180]H))(-[:90]R^{2})}\arrow{<=>}
\chemfig{C^{\alpha}(-[:90]H)(-[:0]COOH)(-[:180]NH_{2})(-[:270]R)}
\schemestop
\caption{Formaci\'{o}n de un dip\'{e}ptido. Se muestran los reactantes sin ionizar para ejemplificar, de forma ionizada  se obtiene lo mismo}\label{fig:pepti}
\end{figure}
