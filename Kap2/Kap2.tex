...
\end{table} 
Como se ha dicho, las interacciones  mostradas arriba no s\'{o}lamente ocurren entre los residuos de la prote\'{i}na sino tambi\'{e}n entre la prote\'{i}na y el entorno que la rodea, por ejemplo, en condiciones fisiol\'{o}gicas con el medio acuoso o con la bicapa fosfolip\'{i}dica. Estas interacciones hacen que cada prote\'{i}na se pliegue de forma \'{u}nica. Sin embargo, de acuerdo a la secuencia de amino\'{a}cidos, ellas tienden a formar dos tipos de plegamientos, el de prote\'{i}nas fibrosas y el de prote\'{i}nas globulares.\\
