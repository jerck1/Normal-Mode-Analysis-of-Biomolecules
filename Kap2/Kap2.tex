...
\begin{figure}[H]
\centering
\definesubmol\a{C^{\alpha}(-[:270]H)(-[:0]C(=[:270]O)(-[:0]OH))(-[:180]NH_{2})(-[:90]R^{1})}
\definesubmol\b{C^{\alpha}(-[:270]H)(-[:0]C(=[:270]O)(-[:0]OH))(-[:180]N(-[:90]H)(-[:180]H))(-[:90]R^{2})}
...
\schemestart\arrow{-U>[\chemfig[scale=0.75]{H_{2}O}][][-1pt]}[180] \schemestop
