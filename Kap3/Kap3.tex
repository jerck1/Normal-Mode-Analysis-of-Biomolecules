...
\begin{figure}
\centering%
\includegraphics[scale=0.28]{Kap3/dibujo.pdf}%
...
\put(-830,8){\textbf{a)}}
\put(12,8){\textbf{b)}}
\includegraphics[trim = -1cm -3cm 0cm 0cm , clip, width=6cm,height=7cm]{Kap3/mult_min.png}%
...
\begin{figure}
\centering%
\includegraphics[scale=0.3]{Kap3/modos_vs_f.png}%
...
\begin{figure}
\centering%
\includegraphics[scale=0.3]{Kap3/resorte.png}%
...
\centering%
%\input{Kap3/mapa.png}
\includegraphics[scale=0.4]{Kap3/mapa.png}%
