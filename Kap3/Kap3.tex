...
El cotransportador de Na+/Galactosa presente en la proteobacteria \textit{Vibrio Parparahaemolyticus } denotado como vSGLT, es un simportador perteneciente a la familia de simportadores de $\mathrm{Na}^+$-soluto SSS.\\
