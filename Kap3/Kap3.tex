...
De acuerdo a estudios experimentales \cite{Veenstra2004LocalCotransporter.}, en el espacio extracelular de la membrana, el sodio se une antes que la galactosa al cotransportador. Sin embargo, el ingreso de los solutos hacia el espacio intermembranal a\'{u}n no ha sido aclarado.\\
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.3]{Kap3/helice2.png}
