...
\put(-70,0){\textbf{(b)}}
\caption{Mon\'{o}mero del cotransportador vSGLT(C\'{o}digo pdb 3dh4); \textbf{(b)}vSGLT mostrado como d\'{i}mero, como aparece en su forma biol\'{o}gica. Imagen obtenida con PyMOL \cite{PyMOL}.}\label{fig:complejo}
\end{figure}
...
En la base de datos del PDB, se encuentra la estructura de vSGLT  como un tetr\'{a}mero con el c\'{o}digo PDB 3DH4. La estructura tetram\'{e}rica es la de la celda unitaria. Mientras que en su ensamblaje biol\'{o}gico forma un d\'{i}mero, ver figura \ref{fig:3dh4}.
\begin{figure}[H]
\centering
\includegraphics[scale=0.1]{Kap3/chainAB.png}
\caption{D\'{i}mero del cotransportador vSGLT (C\'{o}digo pdb 3dh4) como aparece en su forma biol\'{o}gica. Imagen obtenida con PyMOL \cite{PyMOL}.}\label{fig:3dh4}
\end{figure}
...
Cadena A: TM1(4-18), TM2(53-77), TM3(82-99), TM4(129-155), TM5(162-177), TM6(188-205), TM7(255-267), TM8(286-305), TM9(348-377), TM10(397-418), TM11(423-443), TM12(458-472), TM13(479-496), TM14(524-545).\\

Cadena B: 1(4-18), 2(53-64), 3(67-77), 4(82-99), 5(129-155), 6(162-177), 7(188-205), 8(255-267), 9(286-305), 10(348-377), 11(397-418), 12(423-443), 13(458-472), 14(479-496), 15(524-545).\\
...
\caption{Unidad asim\'{e}trica del mutante K294A del cotransportador vSGLT mostrando la cadana principal en forma de "cartoon".Imagen obtenida con PyMOL \cite{PyMOL}. }\label{fig:2xq2}
\end{figure}
