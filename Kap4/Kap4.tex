...
\begin{figure}[h]
 \centering
    ...
    \put(-28,-4){(b)}
   \caption{Modelo de grano grueso de vSGLT mostrando (a) la cadena principal mostrando los carbonos $\alpha$ conectados por enlaces pept\'{i}dicos. (b) los \'{a}tomos de carbono y el ion de sodio conectados mediante resorten a una distancia de corte de $15\AA$. Imagenes obtenidas con el ANM server.}\label{fig:modelo}
\end{figure}
