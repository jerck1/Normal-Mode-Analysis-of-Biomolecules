...
Comparada con la distancia de corte $R_c=10\AA$, los cambios en las fluctuaciones ms son mayores. A simple vista las fluctuaciones ms para los carbonos $\alpha$ y los carbonos $\alpha$ con el \ce{Na^{+}} (gr\'{a}fica roja) y la galactosa (gr\'{a}fica negra) difieren poco, as\'{i} como cuando est\'{a} unido \'{u}nicamente el \ce{Na^{+}} o la galactosa.
\begin{figure}[h]
 \centering
