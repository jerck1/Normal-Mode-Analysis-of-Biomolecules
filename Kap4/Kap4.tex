...
\begin{figure}[h]
 \centering
    ...
    \put(-28,-4){(a)}
    \includegraphics[scale=0.4]{./Kap4/Ca_15_Na_15.png} 
    \put(-28,-4){(b)}
   \caption{Modelo de grano grueso mostrando (a) la cadena principal mostrando los carbonos $\alpha$ y conectada por enlaces pept\'{i}dicos . (b) los \'{a}tomos de carbono y el ion de sodio conectados mediante resorten a una distancia de corte de $15\AA$.}\label{fig:modelo}
\end{figure}
