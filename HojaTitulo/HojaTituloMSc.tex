...
Agradezco a la profesora Yuly Edith S\'{a}nchez Mendoza profesora del departamente de f\'{i}sica por ser una excelente gu\'{i}a en el trabajo. Al profesor Edgar Antonio Reyes Monta\~{n}o del departamento de qu\'{i}mica por sus recomendaciones y ense\~{n}anzas en el manejo de programas y la estructura de prote\'{i}nas. A Eran Eyal y el grupo de biolog\'{i}a de sistemas y computacional de la universidad de Pittsburgh por su pronta respuesta sobre el funcionamiento del ANM server y al profesor Michael Grabe del departamento de qu\'{i}mica farmac\'{e}utica de la universidad de California, San Francisco por sus contribuciones al entendimiento de la estructura cristalina del co-transportador.\\
